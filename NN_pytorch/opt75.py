...
recon_model = torch.load("/project/jhaldar_118/jiayangw/OptSamp/model/opt75_mae_snr"+str(snr))
weight = torch.load("/project/jhaldar_118/jiayangw/OptSamp/model/opt75_mae_mask_snr"+str(snr))
