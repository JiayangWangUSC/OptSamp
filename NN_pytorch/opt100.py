...
recon_model = torch.load("/project/jhaldar_118/jiayangw/OptSamp/model/opt100_mae_snr"+str(10))
...
for epoch in range(max_epochs):
    ...
    torch.save(recon_model,"/project/jhaldar_118/jiayangw/OptSamp/model/opt100_mae_snr"+str(snr))
    torch.save(weight,"/project/jhaldar_118/jiayangw/OptSamp/model/opt100_mae_mask_snr"+str(snr))
