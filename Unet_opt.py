...
mask = torch.load('/project/jhaldar_118/jiayangw/OptSamp/unet_mask_L1_noise0.5')
...
recon_model = torch.load('/project/jhaldar_118/jiayangw/OptSamp/unet_model_L1_noise0.5')
